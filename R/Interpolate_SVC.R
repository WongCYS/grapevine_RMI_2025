...
file_list <- list.files(paste0(wd, "RMI_grapes/RMI2021/spectroscopy/processed_data/"), 
                        pattern = "svc.csv",
...
#save df
write.csv(df_svc, paste0(wd, "RMI_grapes/RMI2021/spectroscopy/processed_data/svc_clean_interp.csv"), row.names = F)
